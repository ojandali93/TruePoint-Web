...
export default function LandingPage() {
  ...
  return (
    <>
      ...
      {/* ── Affiliate Program section hidden 2026-09-02 (Omar) ──────
          Section removed from render; affiliate-terms/affiliate/claim
          routes and the affiliate.service.ts backend are untouched. */}
